...
admin_render_layout_start([
    ...
    'extra_head' => <<<'HTML'
    <style>
        .event-preview-panel { border: 1px solid #e4ebf5; border-radius: 18px; background: #fff; box-shadow: 0 8px 18px rgba(18, 35, 68, 0.04); }
...
<form method="post" action="eventos_importar_confirmados.php" class="event-preview-panel">
