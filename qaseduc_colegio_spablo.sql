...
-- Tiempo de generación: 24-05-2026 a las 12:28:05
...
(3, 'ejemplo de evento', NULL, 'ejemplo de evento deportivo', 'de describe detalladamente', '2026-05-24', '2026-05-24', '15:19:00', '18:19:00', 'Venancio Benavídez 3612, 11700 Montevideo,', 'Deportivo', '#fd7e14', 'uploads/eventos/img-6939-20260524122111-35c903.jpg', NULL, 0, 1, 0, 'publicado', '2026-05-24 16:21:11', '2026-05-24 16:21:11');
...
(3, 4, NULL, '', NULL, 'Rugby del Prado', '', '', '', '', 'Nuestros alumnos participaron en el torneo intercolegial de rugby con excelentes resultados.', 'uploads/noticias/alumno-1-20260523133321-91f3e6.jpg', NULL, 'Leer más', '#', '', '', '', '2025-11-01', 'si', 1, '2026-04-19 19:39:21'),
...
(9, 3, NULL, '', NULL, '', 'Guadalupe', 'jorquera', 'titulo 3', '', 'contenedor de prueba', 'uploads/secciones/hero_principal/img-6939-20260523133210-99d308.jpg', 'uploads/secciones/hero_principal/imagen-fondo-20260514191258-82a3e9.jpg', '', '', '', '', '', NULL, 'si', 1, '2026-04-19 19:44:28'),
...
(20, 3, NULL, 'eticketa ej', NULL, '', 'titulo 1 ejemplo', 'titulo 2 ejemplo', 'titulo 3 ejemplo', '', 'descripcion ejemplo', 'uploads/secciones/hero_principal/alumno-2-20260523133240-318dd4.jpg', 'uploads/secciones/hero_principal/lupe-04-20260420113602-ee9305.jpg', 'botón 1', 'botón url', 'botón  2', 'botón url', '', NULL, 'si', 1, '2026-04-20 11:30:02'),
...
(24, 21, NULL, '', NULL, '', '', '', '', '', '', 'uploads/secciones/video_destacado_home/alumno-1-20260523133509-da6832.jpg', NULL, '', '', '', '', '', NULL, 'si', 1, '2026-05-23 13:34:41');
...
ALTER TABLE `evento_media`
  ...
  ADD KEY `idx_evento_media_evento` (`id_evento`);
...
--
ALTER TABLE `auditoria_log`
  MODIFY `id_log` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
-- Filtros para la tabla `evento_media`
--
ALTER TABLE `evento_media`
  ADD CONSTRAINT `fk_evento_media_evento` FOREIGN KEY (`id_evento`) REFERENCES `eventos` (`id_evento`) ON DELETE CASCADE;
